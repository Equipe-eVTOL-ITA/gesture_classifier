...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/gesture_classifier', ['gesture_classifier/gesture_recognizer.task']),
        ('share/' + package_name + '/gesture_classifier', ['gesture_classifier/gesture_recognizer.py']),
    ],
